...
public static class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        var host = new PrivilegedHelperHost(storageHandler, sftpInitializeHandler, sftpUserHandler, sambaConfigureHandler, testDomainJoinHandler, domainJoinHandler, applyExchangeAclHandler);
